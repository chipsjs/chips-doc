/**
 *
 * @param {Symbol.Iterator} iterator - iter
 * @param {Function: (item) => {}:Promise<Boolean>} [handler = async () => { }] - callback
...
const loop = {
   ...
   * @param {Function<(item) => {}: Promise<void>>} handler - callback
   * @returns {Promise<void>}
   */
   ...
   * @param {Function<(item) => {}: Promise<any>>} handler - callback
   ...
   *
   * @param {Array Iterator} iterator - array iterator
   * @param {Function<(item) => {}:Promise<Boolean>>} handler - callback
   ...
   *
   * @param {Array Iterator} iterator - array iterator
   * @param {Function<(prev, item) => {}:Promise<prev>>} handler - callback
